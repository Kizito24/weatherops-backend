...
4. **Important**: Check the **actual database name** in the connection string (e.g., `weatherops_postgres` or similar)
   - This name will be auto-generated by Render
   - Migrations will use this database name automatically
